...
function getBotResponse(text: string): string {
  ...
  return "Хороший вопрос! Для точной консультации свяжитесь с нашим специалистом: +7 (909) 418-81-61 или оставьте заявку внизу страницы. Или спросите про: ПВХ, ТПО, цена, ремонт, срок, гарантия.";
}
